...
<div class="container">
	...
	<div class="row">
            ...
            <img id="contenido1" src="img/portafolio/roundicons-free.png" class="img-responsive" alt="">
            
            <img  class="oculto img-responsive" id="contenido2" src="img/portafolio/roundicons-free2.png" alt="" />
        	
	</div>
	<div class="row">
		<div class="col-xs-offset-1 col-xs-10 well">
			   <img type="button" onclick="mostrar('contenido1') & ocultar('contenido2')" src="img/portafolio/roundicons-s1.png" class="img-thumbnail">
			   <img type="button" onclick="mostrar('contenido2') & ocultar('contenido1')" src="img/portafolio/roundicons-s2.png" class="img-thumbnail"><br><br><br>
